...
if __name__ == "__main__":
    ...
    # sholder outer
    cv2.circle(img, right_sholder_outer_point, point_radius, right_sholder_outer_color, -1)
    #right sholder inner
    cv2.circle(img, right_sholder_inner_point, point_radius, right_sholder_inner_color, -1)
    #left sholder inner
    cv2.circle(img, left_sholder_inner_point, point_radius, left_sholder_inner_color, -1)
    #left sholder outer
    cv2.circle(img, left_sholder_outer_point, point_radius, left_sholder_outer_color, -1)

    #right elbow outer
    cv2.circle(img, right_elbow_outer_point, point_radius, right_elbow_outer_color, -1)
    #right elbow inner
    cv2.circle(img, right_elbow_inner_point, point_radius, right_elbow_inner_color, -1)
    #left elbow inner
    cv2.circle(img, left_elbow_inner_point, point_radius, left_elbow_inner_color, -1)
    #left elbow outer
    cv2.circle(img, left_elbow_outer_point, point_radius, left_elbow_outer_color, -1)

    #right chest and arm meeting
    cv2.circle(img, right_chest_arm_meeting_point, point_radius, right_chest_arm_meeting_color, -1)
    #left chest and arm meeting
    cv2.circle(img, left_chest_arm_meeting_point, point_radius, left_chest_arm_meeting_color, -1)
    
    #right waist
    cv2.circle(img, right_waist_point, point_radius, right_waist_color, -1)
    #left waist
    cv2.circle(img, left_waist_point, point_radius, left_waist_color, -1)

    #right hip
    cv2.circle(img, right_hip_point, point_radius, right_hip_color, -1)
    #left hip
    cv2.circle(img, left_hip_point, point_radius, left_hip_color, -1)
    
    #stone of trousers
    cv2.circle(img, stone_of_trousers_point, point_radius, stone_of_trousers_color, -1)

    #right Knee outer 
    cv2.circle(img, right_Knee_outer_point, point_radius, right_Knee_outer_color, -1)
    #right Knee inner
    cv2.circle(img, right_Knee_inner_point, point_radius, right_Knee_inner_color, -1)
    
    #left Knee inner
    cv2.circle(img, left_Knee_inner_point, point_radius, left_Knee_inner_color, -1)
    #left Knee outer
    cv2.circle(img, left_Knee_outer_point, point_radius, left_Knee_outer_color, -1)

    #right ankle outer
    cv2.circle(img, right_ankle_outer_point, point_radius, right_ankle_outer_color, -1)
    #right ankle inner
    cv2.circle(img, right_ankle_inner_point, point_radius, right_ankle_inner_color, -1)
    
    #left Knee inner
    cv2.circle(img, left_ankle_inner_point, point_radius, left_ankle_inner_color, -1)
    #left Knee outer
    cv2.circle(img, left_ankle_outer_point, point_radius, left_ankle_outer_color, -1)    
    ...
    print("sholder = ",eclidian_distance(body_keypoints["right_sholder_outer"],body_keypoints["left_sholder_outer"]),"-->",eclidian_distance2(body_keypoints["right_sholder_outer"],body_keypoints["left_sholder_outer"]))
    print("waist = ",eclidian_distance(body_keypoints["right_waist"],body_keypoints["left_waist"]),"-->",eclidian_distance2(body_keypoints["right_waist"],body_keypoints["left_waist"]))
    print("hip = ",eclidian_distance(body_keypoints["left_hip"],body_keypoints["right_hip"]),"-->",eclidian_distance2(body_keypoints["left_hip"],body_keypoints["right_hip"]))
    print("under arm  = ",eclidian_distance(body_keypoints["left_chest_arm_meeting"],body_keypoints["right_chest_arm_meeting"]),"-->",eclidian_distance2(body_keypoints["left_chest_arm_meeting"],body_keypoints["right_chest_arm_meeting"]))
    print("hip knee left  = ",eclidian_distance(body_keypoints["left_hip"],body_keypoints["left_Knee_outer"]),"-->",eclidian_distance2(body_keypoints["left_hip"],body_keypoints["left_Knee_outer"]))
    print("hip knee right  = ",eclidian_distance(body_keypoints["right_hip"],body_keypoints["right_Knee_outer"]),"-->",eclidian_distance2(body_keypoints["right_hip"],body_keypoints["right_Knee_outer"]))
    print("waist knee left  = ",eclidian_distance(body_keypoints["left_waist"],body_keypoints["left_Knee_outer"]),"-->",eclidian_distance2(body_keypoints["left_waist"],body_keypoints["left_Knee_outer"]))
    print("waist knee right  = ",eclidian_distance(body_keypoints["right_waist"],body_keypoints["right_Knee_outer"]),"-->",eclidian_distance2(body_keypoints["right_waist"],body_keypoints["right_Knee_outer"]))
    print("waist hip left  = ",eclidian_distance(body_keypoints["left_waist"],body_keypoints["left_hip"]),"-->",eclidian_distance2(body_keypoints["left_waist"],body_keypoints["left_hip"]))
    print("waist hip right  = ",eclidian_distance(body_keypoints["right_waist"],body_keypoints["right_hip"]),"-->",eclidian_distance2(body_keypoints["right_waist"],body_keypoints["right_hip"]))
    print("knee left  = ",eclidian_distance(body_keypoints["left_Knee_outer"],body_keypoints["left_Knee_inner"]),"-->",eclidian_distance2(body_keypoints["left_Knee_outer"],body_keypoints["left_Knee_inner"]))
    print("knee right  = ",eclidian_distance(body_keypoints["right_Knee_inner"],body_keypoints["right_Knee_outer"]),"-->",eclidian_distance2(body_keypoints["right_Knee_inner"],body_keypoints["right_Knee_outer"]))
    print("knee to ankle right = ",eclidian_distance(body_keypoints["right_Knee_outer"],body_keypoints["right_ankle_outer"]),"-->",eclidian_distance2(body_keypoints["right_Knee_outer"],body_keypoints["right_ankle_outer"]))
    print("knee to ankle left  = ",eclidian_distance(body_keypoints["left_Knee_outer"],body_keypoints["left_ankle_outer"]),"-->",eclidian_distance2(body_keypoints["left_Knee_outer"],body_keypoints["left_ankle_outer"]))
    print("T stone to left knee  = ",eclidian_distance(body_keypoints["stone_of_trousers"],body_keypoints["left_Knee_inner"]),"-->",eclidian_distance2(body_keypoints["stone_of_trousers"],body_keypoints["left_Knee_inner"]))
    print("T stone to right knee  = ",eclidian_distance(body_keypoints["stone_of_trousers"],body_keypoints["right_Knee_inner"]),"-->",eclidian_distance2(body_keypoints["stone_of_trousers"],body_keypoints["right_Knee_inner"]))
