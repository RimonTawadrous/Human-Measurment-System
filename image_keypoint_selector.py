...
if __name__ == "__main__":
    ...
    try:
        ...
        with open(FILE_NAME, 'a') as the_file:
            ...
            the_file.write('image_name = "'+str(image_name)+'"\n')
            the_file.write('SCALE_PERCENT = '+str(SCALE_PERCENT)+'\n')
            the_file.write('UPPER_RATIO = '+str(ratio)+'\n')
            the_file.write('LOWER_RATIO = '+str(ratio)+'\n')
            the_file.write('RATIO = '+str(ratio)+'\n')
            the_file.write('\n')
            ...
            try:
                ...
                the_file.write('\n')
                the_file.write("HIP_HIGHT = "+str(POINTS_DICT[14][1])+"\n")
                the_file.write("RIGHT_HIP_PIXEL ="+str(POINTS_DICT[14])+"\n")
                the_file.write("LEFT_HIP_PIXEL ="+str(POINTS_DICT[15])+"\n")
