...
UPPER_RATIO = 3.259259259
LOWER_RATIO = 2.795180723
HIP_HIGHT = 0
LEFT_HIP_PIXEL = (0, 0)
RIGHT_HIP_PIXEL = (0, 0)
...
def eclidian_distance(point1 , point2):
    ...
    (x2, y2) = point2
    result = 0
    mid = (LEFT_HIP_PIXEL[0]+LEFT_HIP_PIXEL[0]) / 2
...
if __name__ == "__main__":
    ...
    # # sholder outer
    cv2.circle(img, (134,220), point_radius, right_sholder_outer_color, -1)
    #right sholder inner
    cv2.circle(img, (171, 204), point_radius, right_sholder_inner_color, -1)
    #left sholder inner
    cv2.circle(img, (225, 199), point_radius, left_sholder_inner_color, -1)
    #left sholder outer
    cv2.circle(img, (258, 222), point_radius, left_sholder_outer_color, -1)
    #right elbow outer
    cv2.circle(img, (97, 303), point_radius, right_elbow_outer_color, -1)
    #right elbow inner
    cv2.circle(img, (122, 320), point_radius, right_elbow_inner_color, -1)
    #left elbow inner
    cv2.circle(img, (270, 306), point_radius, left_elbow_inner_color, -1)
    #left elbow outer
    cv2.circle(img, (295,307), point_radius, left_elbow_outer_color, -1)
    #right chest and arm meeting
    cv2.circle(img, (142, 260), point_radius, right_chest_arm_meeting_color, -1)
    #left chest and arm meeting
    cv2.circle(img, (253, 260), point_radius, left_chest_arm_meeting_color, -1)
    #right waist
    cv2.circle(img, (147, 338), point_radius, right_waist_color, -1)
    #left waist
    cv2.circle(img, (248, 338), point_radius, left_waist_color, -1)

 
    #right hip
    cv2.circle(img, (143, 377), point_radius, right_hip_color, -1)
    #left hip
    cv2.circle(img, (250,377), point_radius, left_hip_color, -1)
    #stone of trousers
    cv2.circle(img, (198,434), point_radius, stone_of_trousers_color, -1)

    #right Knee outer 
    cv2.circle(img, (148, 499), point_radius, right_Knee_outer_color, -1)
    #right Knee inner
    cv2.circle(img, (185, 499), point_radius, right_Knee_inner_color, -1)
    #right ankle outer
    cv2.circle(img, (152, 590), point_radius, right_ankle_outer_color, -1)
    #right ankle inner
    cv2.circle(img, (177,592), point_radius, right_ankle_inner_color, -1)

    # #left Knee inner
    cv2.circle(img, (210,500), point_radius, left_Knee_inner_color, -1)
    #left Knee outer
    cv2.circle(img, (248 ,500), point_radius, left_Knee_outer_color, -1)
    #left Knee inner
    cv2.circle(img, (222, 592), point_radius, left_ankle_inner_color, -1)
    #left Knee outer
    cv2.circle(img, (245, 590), point_radius, left_ankle_outer_color, -1)    

    HIP_HIGHT = 377
    RIGHT_HIP_PIXEL = (143, 377)
    LEFT_HIP_PIXEL = (250, 377)
